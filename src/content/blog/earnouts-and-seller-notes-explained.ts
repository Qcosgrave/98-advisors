...
export const posts: BlogPost = {
  slug: "earnouts-and-seller-notes-explained",
  ...
  readTime: "6 min read",
  seoTitle: "Earnouts and Seller Notes in M&A Explained for Founders",
  seoDescription:
    "A practical guide to earnouts and seller notes in M&A transactions — what they are, how they work, and what founders should watch for.",
  content: [

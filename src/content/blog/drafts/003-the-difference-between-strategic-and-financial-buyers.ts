...
export const posts: BlogPost = {
  slug: "the-difference-between-strategic-and-financial-buyers",
  ...
  readTime: "5 min read",
  seoTitle: "Strategic vs Financial Buyers in M&A: What Founders Should Know",
  seoDescription:
    "Understand the key differences between strategic and financial buyers in M&A transactions and how each type evaluates acquisition targets.",
  content: [

...
export const posts: BlogPost = {
  slug: "how-to-think-about-valuation-multiples",
  ...
  readTime: "6 min read",
  seoTitle: "Understanding Valuation Multiples in Business Sales",
  seoDescription:
    "A founder-focused guide to valuation multiples in M&A — what drives them, how to contextualize them, and why the headline number never tells the full story.",
  content: [

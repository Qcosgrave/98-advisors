...
export const posts: BlogPost = {
  slug: "founder-transition-planning-before-during-after",
  ...
  readTime: "5 min read",
  seoTitle: "Founder Transition Planning in Business Sales",
  seoDescription:
    "A guide for founders navigating the personal and professional transition that comes with selling a business — from pre-sale planning to post-close adjustment.",
  content: [

...
export const posts: BlogPost = {
  slug: "customer-concentration-risk-in-ma",
  ...
  readTime: "5 min read",
  seoTitle: "Customer Concentration Risk in M&A Transactions",
  seoDescription:
    "Learn why customer concentration is a critical risk factor in M&A and what founders can do to address it before entering a sale process.",
  content: [

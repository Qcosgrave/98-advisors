...
export const posts: BlogPost = {
  slug: "tax-planning-before-selling-your-business",
  ...
  readTime: "6 min read",
  seoTitle: "Tax Planning for Business Sales: Essential Guide for Founders",
  seoDescription:
    "Discover the critical tax planning strategies founders should consider before selling their business — from entity structure to deal allocation and estate planning.",
  content: [

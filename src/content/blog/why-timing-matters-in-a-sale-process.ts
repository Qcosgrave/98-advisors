...
export const posts: BlogPost = {
  slug: "why-timing-matters-in-a-sale-process",
  ...
  readTime: "5 min read",
  seoTitle: "Why Timing Matters in Selling a Business | M&A Advisory",
  seoDescription:
    "Learn why market timing is critical in M&A transactions and how founders can position themselves to sell at the right moment for maximum value.",
  content: [

...
export const posts: BlogPost = {
  slug: "when-to-walk-away-from-a-deal",
  ...
  readTime: "5 min read",
  seoTitle: "When to Walk Away from an M&A Deal | Advisory Insights",
  seoDescription:
    "Learn the warning signs that a deal may not be in your best interest and how founders can make the difficult decision to walk away from an M&A transaction.",
  content: [
